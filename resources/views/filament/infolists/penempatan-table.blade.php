@php
    ...
    // Tetap, kontrak interim, and kontrak isi tetap get penempatan from waran jawatan.
    $needsWaran = ! $isKontrak;
...
@if($needsWaran && ! $waranJawatan)
    <div class="rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 px-4 py-6 text-center text-sm font-medium text-gray-600 dark:text-gray-300">
        Waran belum ditetapkan
    </div>
@else
